...
if [[ "$(uname -s)" == "Darwin" ]]; then
    ...
    export
    LD_LIBRARY_PATH=$HOME/.local/lib:$BREW_PREFIX/lib:$HOME/libfabric/install/lib:$HOME/ompi/install/lib:/usr/local/cuda/lib64:/usr/lib64${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
fi
