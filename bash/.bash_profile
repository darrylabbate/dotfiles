if [[ "$(uname -s)" == "Darwin" ]]; then
    ...
    export LD_LIBRARY_PATH="/home/linuxbrew/.linuxbrew/lib:$HOME/libfabric/install/lib:$HOME/ompi/install/lib:$HOME/gdrcopy/install/lib:$HOME/ucx/install/lib:/usr/local/cuda/lib64:/usr/lib64:${LD_LIBRARY_PATH+:$LD_LIBRARY_PATH}"
fi
